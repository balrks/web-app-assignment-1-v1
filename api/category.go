...
func (ct *categoryAPI) UpdateCategory(c *gin.Context) {
	...
	if err := c.ShouldBindJSON(&updatedCategory); err != nil {
		c.JSON(http.StatusBadRequest, model.NewErrorResponse("internal server error"))
		return
	}
	...
	c.JSON(http.StatusOK, model.NewSuccessResponse("update category success"))
	// TODO: answer here
}
...
func (ct *categoryAPI) DeleteCategory(c *gin.Context) {
	...
	c.JSON(http.StatusOK, model.NewSuccessResponse("delete category success"))
	// TODO: answer here
}
